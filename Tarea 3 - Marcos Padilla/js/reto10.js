...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function mostrarInformacionEmpleado(cedula) {
        //objeto empleados
        const empleados = {
            '109110338': { nombre: 'Pedro Miranda', jornada: 'Diurna', salario: '$1500', foto: '../img/usuario1.jpg', descripcion: 'Diseñador Web' },
            '209110338': { nombre: 'Karla Castro', jornada: 'Nocturna', salario: '$1200', foto: '../img/usuario2.jpg', descripcion: 'Diseñadora UX-UI' },
            '309110338': { nombre: 'Oscar Soto', jornada: 'Diurna', salario: '$1600', foto: '../img/usuario3.jpg', descripcion: 'Programador Web' },
            '409110338': { nombre: 'Rebeca Suarez', jornada: 'Mixta', salario: '$1400', foto: '../img/usuario4.jpg', descripcion: 'Diseñadora gráfica' },
            '509110338': { nombre: 'Pablo Coto', jornada: 'Nocturna', salario: '$1300', foto: '../img/usuario5.jpg', descripcion: 'Analista de sistemas' }
        };
