function evaluarEncuesta() {
  ...
  if (
    ...
    var mensaje1 = "";
    if (
      document.formulario.atencion.checked == true &&
      document.formulario.calidad.checked == true &&
      document.formulario.servicio.checked == true
    ) {
      mensaje1 =
        "¡Gracias por confiar en nosotros y calificarnos bien en nuestros servicios!";
    } else if (
      document.formulario.atencion.checked == false ||
      document.formulario.calidad.checked == false ||
      document.formulario.servicio.checked == false
    ) {
      mensaje1 =
        "Gracias por sus respuestas, tomaremos en cuenta sus respuestas para mejorar.";
    } else if (
      document.formulario.atencion.checked == false &&
      document.formulario.calidad.checked == false &&
      document.formulario.servicio.checked == false
      ...
      mensaje1 =
        "Gracias por sus respuestas, lamentamos no haya tenido la mejor experiencia, lo tomaremos en cuenta para mejorar.";
    }

    var mensaje3 = "";
    if (respuesta4 == "Buena") {
      mensaje3 =
        "Apreciamos que califique nuestra atencion al cliente de buena manera, seguiremos brindando nuestro servicio incluso mejor para seguir complaciendo a nuestros clientes.";
    } else if (respuesta4 == "Regular") {
      mensaje3 =
        "Agradecemos su sinceridad acerca de nuestros servicio de atencion, vamos a trabajar para mejorarlo.";
    } else {
      mensaje3 =
        "Lamentamos nuestra atencion al cliente le haya decepcionado, nos ocuparemos de eso para mejorar pronto y no causar otro problema igual.";
    }
    ...
    if (respuesta3 == "Si") {
      ...
      mensaje2 =
        "Gracias por su respuesta, intentaremos mejorar para que pueda volver a nuestro hotel y sentirse más comodo.";
    }
